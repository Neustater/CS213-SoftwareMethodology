...
public class Parttime extends Employee{
    ...
    public static final double OVERTIME_MULTI = 1.5; //Overtime multiplier
    public static final double PAY_PERIOD_LENGTH = 2;
    public static final int MAX_NORMAL_HOURS = 40;
    ...
    public void calculatePayment() {
        double weeklyHrsWorked = hoursWorked / PAY_PERIOD_LENGTH;
        double normalHrs;
        double overtimeHrs = weeklyHrsWorked - MAX_NORMAL_HOURS;
        double overtimeRate = hourlyRate * OVERTIME_MULTI;
        double payment;
        ...
        overtimeHrs *= PAY_PERIOD_LENGTH;
        normalHrs *= PAY_PERIOD_LENGTH;
